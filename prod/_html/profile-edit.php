                                                    ...
                                                    <div class="form-row profile-edit__row--cols">
                                                        <div class="profile-edit__row-btn">
                                                            ...
                                                            <div class="dropdown js-dropdown">
                                                                <div class="dropdown__text">рекомендуемый размер изображения: 40*40px</div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="form-row__input">
                                                <div class="form-row profile-edit__row--cols">
                                                    <div class="profile-edit__row-btn">
                                                        ...
                                                        <div class="dropdown js-dropdown">
                                                            <div class="dropdown__text"> пароль должен начинаться с буквы и содержать не менее 8 символов</div>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
