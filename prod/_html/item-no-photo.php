                                ...
                                <div class="item__body-left">
                                    <div class="item-gall js-item-gall">
                                        <div class="item-gall__left">
                                            <span class="item-gall__img item-gall__img--1 _no-photo"></span>
                                        </div>
                                        <div class="item-gall__right">
                                            <span class="item-gall__img item-gall__img--2"></span>
                                            <span class="item-gall__img item-gall__img--3"></span>
                                            <span class="item-gall__img item-gall__img--4"></span>
                                        </div>
                                    </div>
                                    <div class="item-text">
