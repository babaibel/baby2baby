                                ...
                                <div class="main-filter__items">
                                                ...
                                                <div class="dropdown dropdown--big js-dropdown">
                                                    <div class="dropdown-menu js-tabs">
                                                        ...
                                                        <div class="dropdown-menu__right">
                                                            <div class="dropdown-menu__tab js-tabs-tab _active">
                                                                <ul class="dropdown-menu-inner">
                                                                    <li class="dropdown-menu-inner__item">
                                                                        <a href="#!" class="dropdown-menu-inner__link">
                                                                            <span class="dropdown-menu-inner__title">See All</span>
                                                                            <span class="dropdown-menu-inner__numbers">2324527</span>
                                                                        </a>
                                                                    </li>
                                                                    <li class="dropdown-menu-inner__item">
                                                                        <a href="#!" class="dropdown-menu-inner__link">
                                                                            <span class="dropdown-menu-inner__title">Scarves</span>
                                                                            <span class="dropdown-menu-inner__numbers">23245</span>
                                                                        </a>
                                                                    </li>
                                                                    <li class="dropdown-menu-inner__item">
                                                                        <a href="#!" class="dropdown-menu-inner__link">
                                                                            <span class="dropdown-menu-inner__title">Glasses</span>
                                                                            <span class="dropdown-menu-inner__numbers">23527</span>
                                                                        </a>
                                                                    </li>
                                                                    <li class="dropdown-menu-inner__item">
                                                                        <a href="#!" class="dropdown-menu-inner__link">
                                                                            <span class="dropdown-menu-inner__title">Hair Accessories</span>
                                                                            <span class="dropdown-menu-inner__numbers">235227</span>
                                                                        </a>
                                                                    </li>
                                                                    <li class="dropdown-menu-inner__item">
                                                                        <a href="#!" class="dropdown-menu-inner__link">
                                                            ...
                                                            <div class="dropdown-menu__tab js-tabs-tab">
                                                                <ul class="dropdown-menu-inner">
                                                                    <li class="dropdown-menu-inner__item">
                                                                        <a href="#!" class="dropdown-menu-inner__link">
                                                                            <span class="dropdown-menu-inner__title">Glasses</span>
                                    ...
                                    <div class="main-filter__col">
                                        <div class="main-filter__item" data-dropdown="active">
                                            <div class="main-filter__item-icon"><span class="iconic iconic--gender"></span></div>
                                            <div class="main-filter__item-inner">
                                                <div class="main-filter__item-subtitle">Brand</div>
                                                <div class="main-filter__item-title">
                                    ...
                                    <div class="main-filter__col">
                                        <div class="main-filter__item" data-dropdown="active">
                                            <div class="main-filter__item-icon"><span class="iconic iconic--cake"></span></div>
                                            <div class="main-filter__item-inner">
                                                <div class="main-filter__item-subtitle">Color</div>
                                                <div class="main-filter__item-title">
                                                    <span>Choose</span>
                                                </div>
                                                <div class="dropdown dropdown--cols js-dropdown">
                                    ...
                                    <div class="main-filter__col">
                                        <div class="main-filter__item" data-dropdown="active">
                                            <div class="main-filter__item-icon"><span class="iconic iconic--gender"></span></div>
                                            <div class="main-filter__item-inner">
                                                <div class="main-filter__item-subtitle">Condition</div>
                                                <div class="main-filter__item-title">
                                                    <span>Choose</span>
                                                </div>
                                                <div class="dropdown dropdown--cols js-dropdown">
                                    ...
                                    <div class="main-filter__col">
                                        <div class="main-filter__item" data-dropdown="active">
                                            <div class="main-filter__item-icon"><span class="iconic iconic--cake"></span></div>
                                            <div class="main-filter__item-inner">
                                                <div class="main-filter__item-subtitle">Existence photo</div>
                                                <div class="main-filter__item-title">
                                                    <span>Yes</span>
                                                </div>
                                                <div class="dropdown dropdown--cols js-dropdown">
                                    ...
                                    <div class="main-filter__col">
                                        <div class="main-filter__item" data-dropdown="active">
                                            <div class="main-filter__item-icon"><span class="iconic iconic--gender"></span></div>
                                            <div class="main-filter__item-inner">
                                                <div class="main-filter__item-subtitle">One item or box</div>
                                                <div class="main-filter__item-title">
                                                    <span>Choose</span>
                                                </div>
                                                <div class="dropdown dropdown--cols js-dropdown">
                        ...
                        <div class="main-catalog main-catalog--leftbar">
                            ...
                            <div class="main-catalog__content">
                                <div class="catalog-wr">
                                    <h1 class="h2">Заголовок название выбранной категории</h1>
                                    <div class="catalog">
                                        <div class="catalog__item">
                                            <div class="product">
                                                <div class="product__header">
                                                    <div class="product__header-fav">
                                                        <a href="#!" class="btn-fav iconic iconic--star" data-toggle="active"></a>
                                                    </div>
